...
win(multiple, pr(expP, expQ))
bustP <- c(3,2,2,1,2,1,0)
bustQ <- c(2,2,3,2,3,3,2)
goBustProb(bustP, bustQ)
q^2*(1 + (1+q)*p + (1+2*q)*p^2 + p^3)
...
## (5,4)
expP <- c(5,4,4,3,4,3,3,2,4,3,3,2,3,2,2,1,4,3,3,2,3,2,2,1,3,2,2,1,2,1,0)
expQ <- c(0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4,1,2,2,3,2,3,3,4,2,3,3,4,3,4,4)
sum(pr(expP, expQ))
multiple <- c(5,3,4,0,4,2,3,-5,4,2,3,-1,3,1,2,-14,4,2,3,-1,3,1,2,-6,3,1,2,-2,2,0,-15)
win(multiple, pr(expP, expQ))
bustP <- c(1,0)
bustQ <- c(4,4)
goBustProb(bustP, bustQ)
...
## (5,5)
expP <- c(5,4,4,3,4,3,3,2,4,3,3,2,3,2,2,1,4,3,3,2,3,2,2,1,3,2,2,1,2,1,1,0)
expQ <- c(0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4,1,2,2,3,2,3,3,4,2,3,3,4,3,4,4,5)
sum(pr(expP, expQ))
multiple <- c(5,3,4,0,4,2,3,-5,4,2,3,-1,3,1,2,-14,4,2,3,-1,3,1,2,-6,3,1,2,-2,2,0,1,-31)
win(multiple, pr(expP, expQ))
bustP <- c(0)
bustQ <- c(5)
goBustProb(bustP, bustQ)
